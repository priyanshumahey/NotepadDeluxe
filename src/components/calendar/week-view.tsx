...
// Define any missing utility functions locally
function formatTimeWithoutPeriod(date: Date): string {
...
function getTimePosition(date: Date): number {
  ...
  return hours * WeekCellsHeight + (minutes / 60) * WeekCellsHeight;
}

function getDayColumnEvents(events: CalendarEvent[], day: Date): CalendarEvent[] {
